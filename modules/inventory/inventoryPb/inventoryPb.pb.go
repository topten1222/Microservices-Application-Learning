...
type IsAvailableToSellToReq struct {
...
func (x *IsAvailableToSellToReq) Reset() {
	*x = IsAvailableToSellToReq{}
	mi := &file_modules_inventory_inventoryPb_inventoryPb_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IsAvailableToSellToReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAvailableToSellToReq) ProtoMessage() {}

func (x *IsAvailableToSellToReq) ProtoReflect() protoreflect.Message {
	mi := &file_modules_inventory_inventoryPb_inventoryPb_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use IsAvailableToSellToReq.ProtoReflect.Descriptor instead.
func (*IsAvailableToSellToReq) Descriptor() ([]byte, []int) {
	return file_modules_inventory_inventoryPb_inventoryPb_proto_rawDescGZIP(), []int{0}
}

func (x *IsAvailableToSellToReq) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *IsAvailableToSellToReq) GetItemId() string {
	if x != nil {
		return x.ItemId
	}
	return ""
...
type IsAvailableToSellToRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *IsAvailableToSellToRes) Reset() {
	*x = IsAvailableToSellToRes{}
	mi := &file_modules_inventory_inventoryPb_inventoryPb_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *IsAvailableToSellToRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAvailableToSellToRes) ProtoMessage() {}

func (x *IsAvailableToSellToRes) ProtoReflect() protoreflect.Message {
	mi := &file_modules_inventory_inventoryPb_inventoryPb_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAvailableToSellToRes.ProtoReflect.Descriptor instead.
func (*IsAvailableToSellToRes) Descriptor() ([]byte, []int) {
	return file_modules_inventory_inventoryPb_inventoryPb_proto_rawDescGZIP(), []int{1}
}

func (x *IsAvailableToSellToRes) GetIsAvailable() bool {
	if x != nil {
...
var file_modules_inventory_inventoryPb_inventoryPb_proto_rawDesc = []byte{
	...
	,
...
var file_modules_inventory_inventoryPb_inventoryPb_proto_goTypes = []any{
	(*IsAvailableToSellToReq)(nil), // 0: IsAvailableToSellToReq
	(*IsAvailableToSellToRes)(nil), // 1: IsAvailableToSellToRes
}
var file_modules_inventory_inventoryPb_inventoryPb_proto_depIdxs = []int32{
	0, // 0: InventoryGrpcService.IsAvailableToSell:input_type -> IsAvailableToSellToReq
	1, // 1: InventoryGrpcService.IsAvailableToSell:output_type -> IsAvailableToSellToRes
