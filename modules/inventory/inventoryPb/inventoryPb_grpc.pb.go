...
type InventoryGrpcServiceClient interface {
	IsAvailableToSell(ctx context.Context, in *IsAvailableToSellToReq, opts ...grpc.CallOption) (*IsAvailableToSellToRes, error)
}
...
func (c *inventoryGrpcServiceClient) IsAvailableToSell(ctx context.Context, in *IsAvailableToSellToReq, opts ...grpc.CallOption) (*IsAvailableToSellToRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsAvailableToSellToRes)
...
type InventoryGrpcServiceServer interface {
	IsAvailableToSell(context.Context, *IsAvailableToSellToReq) (*IsAvailableToSellToRes, error)
...
func (UnimplementedInventoryGrpcServiceServer) IsAvailableToSell(context.Context, *IsAvailableToSellToReq) (*IsAvailableToSellToRes, error) {
...
func _InventoryGrpcService_IsAvailableToSell_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryGrpcServiceServer).IsAvailableToSell(ctx, req.(*IsAvailableToSellToReq))
	}
