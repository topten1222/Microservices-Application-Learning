...
func (c *itemGrpcServiceClient) FindItemsInIds(ctx context.Context, in *FindItemsInIdsReq, opts ...grpc.CallOption) (*FindItemsInIdsRes, error) {
	...
	err := c.cc.Invoke(ctx, ItemGrpcService_FindItemsInIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedItemGrpcServiceServer must be embedded to have
...
func (UnimplementedItemGrpcServiceServer) testEmbeddedByValue()                         {}
...
func RegisterItemGrpcServiceServer(s grpc.ServiceRegistrar, srv ItemGrpcServiceServer) {
	// If the following call pancis, it indicates UnimplementedItemGrpcServiceServer was
