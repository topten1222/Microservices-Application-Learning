...
type PlayerGrpcServiceClient interface {
	...
	GetPlayerSavingAccount(ctx context.Context, in *GetPlayerSavingAccountReq, opts ...grpc.CallOption) (*PlayerSavingAccountRes, error)
}
...
func (c *playerGrpcServiceClient) GetPlayerSavingAccount(ctx context.Context, in *GetPlayerSavingAccountReq, opts ...grpc.CallOption) (*PlayerSavingAccountRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PlayerSavingAccountRes)
...
type PlayerGrpcServiceServer interface {
	...
	GetPlayerSavingAccount(context.Context, *GetPlayerSavingAccountReq) (*PlayerSavingAccountRes, error)
...
func (UnimplementedPlayerGrpcServiceServer) GetPlayerSavingAccount(context.Context, *GetPlayerSavingAccountReq) (*PlayerSavingAccountRes, error) {
